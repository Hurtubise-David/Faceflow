...
var expectOkWithValue = function (result, expectedValue) {
    return expect(result).to.be.an.instanceof(result_1.Ok).and.to.deep.equal(result_1.ok(expectedValue));
};
...
describe('json-decoder', function () {
    ...
    describe('nullable', function () {
        var nullableStringDecoder = json_decoder_1.JsonDecoder.nullable(json_decoder_1.JsonDecoder.string);
        it('should decode a null value', function () {
        ...
        it('should fail on undefined value', function () {
            var expectedErrorResult = json_decoder_1.JsonDecoder.string.decode(undefined);
            var result = nullableStringDecoder.decode(undefined);
            expect(result).to.deep.equal(expectedErrorResult);
        });
        it('should fail with message from wrapped decoder when unable to decode object', function () {
            var expectedErrorResult = json_decoder_1.JsonDecoder.string.decode(1);
    ...
    describe('combine', function () {
        var nameDecoder = json_decoder_1.JsonDecoder.object({ name: json_decoder_1.JsonDecoder.string }, 'WithName');
        var ageDecoder = json_decoder_1.JsonDecoder.object({ age: json_decoder_1.JsonDecoder.number }, 'WithAge');
        var combinedDecoder = json_decoder_1.JsonDecoder.combine(nameDecoder, ageDecoder);
